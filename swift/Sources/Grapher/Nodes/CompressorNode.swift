...
public final class CompressorNode: Node {
    ...
    /**
        ...
        - Parameters:
            ...
            - thresholdDb: An audio parameter specifying the threshold (in dB) at which compression will start.
            - kneeDb: An audio parameter specifying the range (in dB) above the threshold at which point the compression curve transitions to the ratio portion.
    ...
    public init(id: String = IDGenerator.generateUniqueID(), detectionMode: DetectionMode = .max, kneeMode: KneeMode = .hard, cutoffs: [Double] = [], thresholdDb: AudioParam, kneeDb: AudioParam, ratioDb: AudioParam, attack: AudioParam, release: AudioParam) {
        ...
        super.init(id: id, kind: .compressorNode)
    }
