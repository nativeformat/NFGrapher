...
export function createRenderData(def: string) {
...
export default function render(def: string): OutputFile {
  const renderData = createRenderData(def);
  const filepath = `Sources/Grapher/Version.swift`;
  const content = /* prettier-ignore */ source`
        ...
        public struct Version: Codable {
            ...
            /// Current version.
            public static let current: Version = Version(${renderData.major}, ${renderData.minor}, ${renderData.patch})
