...
public class ExpanderNode extends TypedNode {

  /** Unique identifier for the plugin kind this node represents. */
  public static final String PLUGIN_KIND = "com.nativeformat.plugin.compressor.expander";
   ...
   * @return a new ExpanderNode
   */
  public static ExpanderNode create(Config config) {
   ...
   * @return a new ExpanderNode
   */
  public static ExpanderNode create(LoadingPolicy loadingPolicy, Config config) {
   ...
   * @return a new ExpanderNode
   */
  public static ExpanderNode create(String id, LoadingPolicy loadingPolicy, Config config) {
  ...
  /**
   * Creates a new ExpanderNode from the given Score Node.
   *
   * @param node the Score Node to convert from
   * @return a new ExpanderNode
   */
  public static ExpanderNode from(Node node) {
  ...
  /**
   * The shape of the knee in the expansion function. Possible values are hard and soft. This
  ...
  /**
   * A list of cutoff frequencies in Hz for multiband expansion. If the list is empty, no band
  ...
  /**
   * A configuration class for a ExpanderNode.
   *
   * @see ExpanderNode#create(Config)
   * @see ExpanderNode#create(LoadingPolicy, Config)
   * @see ExpanderNode#create(String, LoadingPolicy, Config)
   */
  public static class Config {
     ...
     *
     * @see ExpanderNode#detectionMode()
